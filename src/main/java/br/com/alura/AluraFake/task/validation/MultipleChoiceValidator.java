...
@Component
public class MultipleChoiceValidator implements TaskValidator<NewMultipleChoiceTaskDTO> {

    @Override
    public ResponseEntity<ErrorItemDTO> validate(NewMultipleChoiceTaskDTO dto) {
        ...
        long correctCount = dto.getOptions().stream()
                ...
                .sum();
        long incorrectCount = dto.getOptions().size() - correctCount;
